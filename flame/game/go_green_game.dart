...
class GoGreenGame extends FlameGame<GoGreenWorld>
  ...
  bool isGameOver = false; // tambah flag untuk cek game over
  ...
  void gameOver() {
    if (!isGameOver) {
      isGameOver = true;
      pauseEngine();
      overlays.add('gameOver'); // Tampilkan layar Game Over
    }
  }
  ...
  void reset(){
    ...
    //hapus semua komponen di dunia lama dan buat ulang
...
//buat deteksi drag di layar handphone device kanan dan kiri
  ...
  KeyEventResult onKeyEvent(
    ...
    if (event is KeyDownEvent) {
      // Ubah dari RawKeyDownEvent ke KeyDownEvent
