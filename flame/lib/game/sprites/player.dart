...
class Player extends SpriteComponent with HasGameRef<GoGreenGame> {
  ...
  void update(double dt){//value pakai dt itu delta time kayak counter yang ngitung 1234 increase y by the value of that time
    ...
    double newY=  position.y + (dt *500);//dia bisa turun karena dt selalu bertambah kalau mau jatohnya tambah lama bisa diatur angka 400 nya dikurangin
    //bisa dicek posisi barunya di dalam batas sceen kita
