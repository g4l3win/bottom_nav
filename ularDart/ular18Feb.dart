...
//  print(ular[1][1]); //keluar kanan bawah
  ...
  List<int> arah = [1, -0]; // Mulai [1,0] kanan [-1,0] kiri [0,-1] keatas [0,1] kebawah
  List<int> makanan = [6, 5]; // Posisi awal makanan
